...
let {id, name, imageLink} = route.params
...
return(
<RecipeCard style={{position:'relative'}} data={item} ingredients={ingredients} imageLink={imageLink}/> 
)
} 
...
<View style={{flex:'1', justifyContent:'center', alignItems:'center',backgroundColor:'#191414'}}>
    <Text style={{width:'90vw',minWidth: '250px', maxWidth:'500px', fontSize:'18px',textAlign:'center', backgroundColor:'rgba(245, 245, 245, 0.9)', position:'absolute', zIndex:'5', top:'0',padding:'5px', backdropFilter: 'grayscale(90%)'  }}> 
    {name} </Text>
